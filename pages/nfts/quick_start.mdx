...
This guide will help you get started with the Wobbl3 NFT smart contract integration. It will guide you through the process of adding your contract to the Wobbl3 dashboard.
...
## Step 1: Add your NFT contract to the Mintboss dashboard
  ...
  1. Go to the [dashboard](mintboss.wobbl3.io) and log in with your Wobbl3 account
