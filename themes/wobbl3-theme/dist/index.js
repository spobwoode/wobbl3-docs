...
function Head() {
  ...
  return /* @__PURE__ */ jsx19(Fragment9, { children: /* @__PURE__ */ jsx19(NextHead, { children: /* @__PURE__ */ jsx19("title", { children: "Title" }) }) });
}
...
function NavbarMenu({
  ...
  return /* @__PURE__ */ jsx21("div", { className: "nx-relative nx-inline-block", children: /* @__PURE__ */ jsxs15(Menu, { children: [
    /* @__PURE__ */ jsx21(
      Menu.Button,
      {
        className: cn14(
...
function FolderImpl({ item, anchors }) {
  ...
  return /* @__PURE__ */ jsxs16("li", { className: cn15({ open, active }), children: [
    /* @__PURE__ */ jsxs16(
      Anchor,
      {
...
function File2({
  ...
  return /* @__PURE__ */ jsxs16("li", { className: cn15(classes5.list, { active }), children: [
    /* @__PURE__ */ jsx24(
      Anchor,
      {
          ...
          hasMenu && /* @__PURE__ */ jsxs16(
            "div",
            {
              ...
              children: [
                ...
                config.darkMode && /* @__PURE__ */ jsx24("div", { className: showSidebar && !hasI18n ? "nx-grow nx-flex nx-flex-col" : "", children: renderComponent(config.themeSwitch.component, {
...
function Tab(_a) {
  ...
  return /* @__PURE__ */ jsx27(HeadlessTab.Panel, { className: "nx-rounded nx-pt-6", children });
}
...
import { useEffect as useEffect4, useRef as useRef6, useMemo as useMemo4 } from "react";
...
import { Fragment as Fragment12, jsx as jsx31, jsxs as jsxs20 } from "react/jsx-runtime";
...
var pageThemeSchema = z2.strictObject({
  breadcrumb: z2.boolean(),
  collapsed: z2.boolean(),
  footer: z2.boolean(),
  layout: z2.enum(["default", "full", "raw"]),
  navbar: z2.boolean(),
  pagination: z2.boolean(),
  sidebar: z2.boolean(),
  timestamp: z2.boolean(),
  toc: z2.boolean(),
  typesetting: z2.enum(["default", "article"])
});
...
var displaySchema = z2.enum(["normal", "hidden", "children"]);
var titleSchema = z2.string();
var linkItemSchema = z2.strictObject({
  href: z2.string(),
  newWindow: z2.boolean(),
  title: titleSchema
});
var menuItemSchema = z2.strictObject({
  display: displaySchema.optional(),
  items: z2.record(linkItemSchema.partial({ href: true, newWindow: true })),
  title: titleSchema,
  type: z2.literal("menu")
});
var separatorItemSchema = z2.strictObject({
  title: titleSchema,
  type: z2.literal("separator")
});
var itemSchema = linkItemSchema.extend({
  display: displaySchema,
  theme: pageThemeSchema,
  title: titleSchema,
  type: z2.enum(["page", "doc"])
}).deepPartial();
var metaSchema = z2.string().or(menuItemSchema).or(separatorItemSchema).or(itemSchema);
...
import { Fragment as Fragment13, jsx as jsx33, jsxs as jsxs22 } from "react/jsx-runtime";
var classes6 = {
